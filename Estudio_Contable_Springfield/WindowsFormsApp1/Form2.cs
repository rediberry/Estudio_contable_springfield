...
{
    public partial class Form2 : Form, IFormulario
    {
        ...
        public Form2(Empresa parametros)
        {
            this._cs = new CategoriasServicio();
            this._emprs = new EmpresaServicio();
            this._empls = new EmpleadoServicio();
            this._ls = new LiquidacionesServicio();
            this._empr = (Empresa)parametros;
            InitializeComponent();
        }
        #region métodos
        ...
        {            
            ...
            //comboBox1.SelectedIndex = comboBox1.FindString(_empr.ToString());
